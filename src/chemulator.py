...
from tensorflow.keras.layers import Dropout,Average, GaussianNoise
...
class Chemulator:
    ...
    def load_model(self,model_folder):
        ...
        variables=list(self.input_scaling_summary.index)
        self.chem_labels=[x for x in variables if "Chem" in x]
        self.physics_labels=[x for x in variables if "Chem" not in x]
